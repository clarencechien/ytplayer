...
單支英文樣本一輪 ≈ NT$5–7 → **基準 3 次 + 候選 3 次 ≈ NT$35**；兩支樣本都跑 ≈ NT$90。
這是「換模型」這個決定的合理價格：2026-08-13 的帳單事故一天就是 NT$1000+。
...
| 2026-08-16 | F1 協定改動 | v4 vs v5（回聲對位） | 見 [future-ideas.md](future-ideas.md) F1 實測 | 同上 |
